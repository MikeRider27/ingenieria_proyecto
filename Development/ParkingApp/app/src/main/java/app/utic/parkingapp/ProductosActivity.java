...
public class ProductosActivity extends AppCompatActivity {
        ...
        public void onClick(DialogInterface dialog, int which) {
            switch (which){
                case DialogInterface.BUTTON_POSITIVE:
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (parentObject.getString("CREATE").equals("OK")){
                                    ...
                                    et_costo.setText("");
                                    et_precio.setText("");
                                    Toast.makeText(ProductosActivity.this, "Registro eliminado con exito!!!", Toast.LENGTH_SHORT).show();
                                    cargaLista();
                    ...
                    requestQueue = Volley.newRequestQueue(ProductosActivity.this);
                    requestQueue.add(stringRequest);
                    Cancelar();
                    break;
    ...
    private void cargaLista() {
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(ProductosActivity.this,R.layout.support_simple_spinner_dropdown_item);
