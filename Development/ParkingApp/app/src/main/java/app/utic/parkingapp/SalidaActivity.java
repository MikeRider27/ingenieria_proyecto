    ...
    private void Eliminar() {
        ...
        if (!codigo.isEmpty()) {
            ...
            builder.setPositiveButton("Sí", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    //if (!codigo.isEmpty()) {
                    AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(SalidaActivity.this, "administracion", null, 1);
                    SQLiteDatabase BaseDeDatos = admin.getWritableDatabase();
                       ...
                       if (cantidad == 1) {
                            Toast.makeText(SalidaActivity.this, "Registro Eliminado", Toast.LENGTH_LONG).show();
                            cargaDetalle();
                            CalcuTotal();
                        } else {
                        }
            ...
            Toast.makeText(SalidaActivity.this, "Seleccione Elemento", Toast.LENGTH_LONG).show();
        }
       /* if(!codigo.isEmpty())
