...
public class TipobahiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista = (ListView) findViewById(R.id.listatipbahias);
    ...
    public void registrarBtn(View View) {
        ...
        if(descri.isEmpty()){
            ...
            String URL = ENLACE+"tipo_bahia.php?accion=insert&nom_tipbahia="+txtDescripcion.getText().toString();
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (parentObject.getString("status").equals("success")){
                            ...
                            Toast.makeText(TipobahiaActivity.this, message, Toast.LENGTH_SHORT).show();
                            Cargarlista();
    ...
    public void Modificar(View view) {
        final String URL = ENLACE+"tipo_bahia.php?accion=update&id_tipbahia="+txtCodigo.getText().toString()+"&nom_tipbahia="+txtDescripcion.getText().toString();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
    ...
    public void Eliminar(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(TipobahiaActivity.this);
        ...
        public void onClick(DialogInterface dialog, int which) {
            switch (which){
                case DialogInterface.BUTTON_POSITIVE:
                    String URL = ENLACE+"tipo_bahia.php?accion=delete&id_tipbahia="+txtCodigo.getText().toString();
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            try {
                    ...
                    requestQueue = Volley.newRequestQueue(TipobahiaActivity.this);
                    requestQueue.add(stringRequest);
                    Cancelar();
                    break;
    ...
    public void Buscar() {
        String URL = ENLACE+"tipo_bahia.php?accion=search&id_tipbahia="+txtCodigo.getText().toString();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (parentObject.getString("status").equals("success")){
                        ...
                        //txtDescripcion.setText("");
                        //Toast.makeText(tipbahias3Activity.this, "Recuperado", Toast.LENGTH_SHORT).show();
                        Cargarlista();
    ...
    private void Cargarlista() {
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(TipobahiaActivity.this,R.layout.support_simple_spinner_dropdown_item);
        String URL=ENLACE+"tipo_bahia.php?accion=select";
