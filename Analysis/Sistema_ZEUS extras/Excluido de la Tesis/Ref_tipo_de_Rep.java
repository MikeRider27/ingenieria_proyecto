 ...
 * @author schafler92
 */
public class Ref_tipo_de_Rep extends javax.swing.JInternalFrame {
    
    private final conectarDB DB; 
    int bandera,isOk=0;
    String aop,cod,see="est_des='VIG'";

    public Ref_tipo_de_Rep() {
        initComponents();
        DB = new conectarDB();
        ManageButtons(1); 
    }
...
new TblThread("SELECT * FROM v_trep WHERE trep_des LIKE '%"+txtBuscar.getText().trim().toUpperCase()+"%' AND "+see 
        + " ORDER BY 2 ASC", jTable1,null,null,DB.con,this,new int[]{1,2}).start();   
        }
    }      
    ...
    private void initComponents() {
        ...
        setTitle("Mantener Tipos de Repuestos");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cboSee, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
private void al_agregar(){
    bandera=1;
cod=DB.getDBcod("trep_cod","v_trep");
txtCod.setText(cod);
ManageButtons(3);
txtDes.requestFocus();
}
...
save();  
    ...
    isOk=DB.executeCst("abm_trep(?,?,?)", tipos_de_get,parametros,true);
